...
export const AddTaskIcon: React.FC<AddTaskIconProps> = ({ size = 24, color = '#7d7d7d' }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 444.25 444.25">
      <Path
        fill={color}
      ...
      />
      <Rect fill={color} x="210.78" y="146.63" width="18.61" height="164.81" />
      <Rect
        fill={color}
        x="210.78"
        y="146.63"
        width="18.61"
        height="164.81"
        transform="translate(449.12 8.96) rotate(90)"
      />
    </Svg>
  );
};
